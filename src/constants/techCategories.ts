...
export const TECH_CATEGORIES: TechCategory[] = [
  ...
  },
  {
    ...
    techs: ["Redux", "Zustand", "Jotai", "Recoil", "MobX"],
  },
  {
    label: "Data Fetching",
    color: "bg-cyan-100 text-cyan-800",
    techs: ["TanStack Query", "SWR", "Axios", "GraphQL"],
  },
  {
    label: "Build / Tooling",
    color: "bg-yellow-100 text-yellow-800",
    techs: ["Vite", "Webpack", "Turbopack", "SWC", "Turborepo", "Nx", "Rollup", "Bun", "Biome"],
  },
  {
    label: "Testing",
    color: "bg-green-100 text-green-800",
    techs: ["Jest", "Vitest", "Playwright", "Cypress", "Testing Library", "Storybook"],
  },
  {
